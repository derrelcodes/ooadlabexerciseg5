// derrelcodes/ooadlabexerciseg5/ooadlabexerciseg5-main/DrawingStudioPro.java
import javax.swing.*;
import java.awt.*;
...
public class DrawingStudioPro {
    ...
    static class MainFrame extends JFrame {
        public MainFrame() {
            ...
            // ===== WEST: Collection Panel (Media) =====
            CollectionPanel collectionPanel = new CollectionPanel();
            collectionPanel.setPreferredSize(new Dimension(270, 0));
            ...
            add(collectionPanel, BorderLayout.WEST);
            ...
            SwingUtilities.invokeLater(() -> canvasSplitPane.setDividerLocation(0.5));
        }
    }
}